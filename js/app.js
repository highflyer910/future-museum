...
function renderGallery() {
  ...
  filtered.forEach(e => {
    ...
    `;
    card.addEventListener("click", () => openExhibit(e.id));
...
// Fade in exhibit cards as they scroll into view
...
// Hero rings subtle pulse (smoother than CSS)
gsap.to('.ring', {
  scale: 1.05,
  opacity: 0.4,
  duration: 3,
